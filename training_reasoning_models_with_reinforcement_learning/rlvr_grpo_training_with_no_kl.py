...
from training_reasoning_models_with_reinforcement_learning.load_math_train import load_math_train
from base_model.qwen import KVCache, Qwen3Model, QWEN_CONFIG_06_B
from safetensors.torch import load_file, save_file
from evaluating_reasoning_models.tokenizer_only import load_tokenizer_only
...
if __name__ == "__main__":
    ...
    if args.checkpoint_path:
        ...
        model, tokenizer = load_model_and_tokenizer(
            which_model="base", use_compile=False,
        )
    ...
    CHECKPOINT_DIR.mkdir(parents=True, exist_ok=True)
    save_file(trained.state_dict(), str(CHECKPOINT_DIR / "qwen3-0.6B-rlvr-grpo.safetensors"))